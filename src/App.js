  ...
  return (
    <div className="App">
      ...
      <section className="quick-features">
        <h2 className="quick-features-title">Quick solutions, less stress</h2>

        <div className="all-features">
          <div className="features-I feature">
            <div className="logos">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
          ...
          <div className="features-II feature">
            <div className="logos">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
          ...
          <div className="features-III feature">
            <div className="logos">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
      ...
      <section className="mini-hero">
        <h2 className="mini-hero-title">Instant setup, no custom code</h2>
        ...
        <img src={heroImage} className="mini-hero-image" />
      </section>

      <section className="get-in-touch">
        <h2 className="get-in-touch-heading">Get in touch</h2>

        <p className="get-in-touch-desc">Request a demo, or hop on a call.</p>
